...
CORE_TOOLS="index_repository search_graph trace_path get_code_snippet"
CORE_TOOLS="$CORE_TOOLS search_code get_edit_plan get_change_risks"
...
echo "OK: all 7 core MCP/workflow tools present in tools/list"
